-- Initial Schema
-- Description: Creates the base database schema with users and api_keys tables
-- Date: 2026-03-24
-- Note: This is the complete schema for fresh database initialization (e.g., CI/CD)
